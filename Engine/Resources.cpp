...
void Resources::CreateDefaultShader()
{
	// skybox
	{
		...
		shader->Init(L"..\\Resources\\Shaders\\skybox.fx", info);
	...
	// Deferred (Deferred)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->Init(L"..\\Resources\\Shaders\\Deferred.fx", info);
	...
	// Forward (Forward)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->Init(L"..\\Resources\\Shaders\\forward.fx", info);
	...
	// Texture (Forward)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->Init(L"..\\Resources\\Shaders\\forward.fx", info, "VS_Tex", "PS_Tex");
	...
	// DirLight
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->Init(L"..\\Resources\\Shaders\\lighting.fx", info, "VS_DirLight", "PS_DirLight");
	...
	// PointLight
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->Init(L"..\\Resources\\Shaders\\lighting.fx", info, "VS_PointLight", "PS_PointLight");
	...
	// Final Assembler
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->Init(L"..\\Resources\\Shaders\\lighting.fx", info, "VS_Final", "PS_Final");
