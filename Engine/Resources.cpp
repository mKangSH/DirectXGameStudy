...
void Resources::CreateDefaultShader()
{
	// skybox
	{
		...
		shader->CreateGraphicsShader(L"..\\Resources\\Shaders\\skybox.fx", info);
	...
	// Deferred (Deferred)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\Resources\\Shaders\\Deferred.fx", info);
	...
	// Forward (Forward)
	{
		...
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateGraphicsShader(L"..\\Resources\\Shaders\\forward.fx", info);
	...
	{
		shared_ptr<Shader> shader = make_shared<Shader>();
		shader->CreateComputeShader(L"..\\Resources\\Shaders\\compute.fx", "CS_Main", "cs_5_0");
...
void Resources::CreateDefaultMaterial()
{
	...
	// Terrain
	{
		...
		shared_ptr<Texture> texture = GET_SINGLE(Resources)->Load<Texture>(L"Terrain", L"..\\Resources\\Textures\\Terrain\\grass_ground_d.jpg");
		shared_ptr<Texture> normalTexture = GET_SINGLE(Resources)->Load<Texture>(L"Terrain_Normal", L"..\\Resources\\Textures\\Terrain\\grass_ground_n.jpg");
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		material->SetTexture(0, texture);
